  ...
  return (
    <main className="site-shell">
      ...
      <article className="content">
        ...
        <section><h2>More paint planning help</h2><p>See the step-by-step guide: <a href="/how-much-paint-do-i-need">How Much Paint Do I Need?</a></p><p>Need help choosing the right coverage input? Read the <a href="/paint-coverage-guide">paint coverage per gallon guide</a>.</p></section>
      </article>
